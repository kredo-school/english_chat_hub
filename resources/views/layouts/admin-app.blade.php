    ...
    <header>
        ...
        <nav id="nav-side">
            <ul class="admin-sidebar adminmenu-icon mt-5">
                <li class="mb-5"><a href="{{ route('admin.users.show') }}"><i class="fa-solid fa-users"></i></a></li>
                <li class="mb-5"><a href="{{ route('admin.chatrooms.meetings.index') }}"><i
                            class="fa-sharp fa-solid fa-comment"></i></a></li>
                <li class="mb-5"><a href="{{ route('admin.inbox.show') }}"><i class="fa-solid fa-inbox"></i></a></li>
                <li class="mb-5"><a href="{{ route('admin.events.show') }}"><i
                            class="fa-solid fa-calendar-check"></i></a></li>
            </ul>
        </nav>
    </header>
